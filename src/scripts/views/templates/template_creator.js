...
const createRestoDetailTemplate = (resto) => `
  ...
  <img class="restaurant__poster lazyload" data-src="${CONFIG.IMAGE_ENDPOINT_LARGE + resto.pictureId}" alt="${resto.name}" />
  ...
  <div class="restaurant-item">
    <div class="restaurant-item__header">
      <img class="restaurant-item__header__poster lazyload" alt="${resto.name}"
           data-src="${resto.pictureId ? CONFIG.IMAGE_ENDPOINT_LARGE + resto.pictureId : 'https://picsum.photos/id/666/800/450?grayscale'}">
